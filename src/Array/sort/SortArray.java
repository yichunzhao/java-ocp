 ...
 * <p>
 * Using helper Arrays
 * sort(byte[] a); sort(byte[], int fromIndex, int toIndex);
 * sort(int[] a); sort(int[] a, int fromIndex, int toIndex);
 * sort(Object[] a); sort(Object[], fromIndex, int toIndex);
 * sort(T[] a, Comparator<? super T> c)
 * sort(T[] a, Comparator<? super T> c, int fromIndex, int toIndex);
 * <p>
 * Object array without implement Comparable interface will throw a Runtime exception.
 */
class Person {
    private String name;
