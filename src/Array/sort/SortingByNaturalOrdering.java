...
/**
 * Natural ordering: ordered by the implemented Comparable interface. Comparator provides external
 * comparing.
 *
 * <p>Comparable interface; compareTo method return int <0 a<b incremental =0 a=b equal >0 a>b
 * decremental
 *
 * @author YNZ
 */
