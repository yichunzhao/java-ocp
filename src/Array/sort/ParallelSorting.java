 ...
 *
 * <p>Arrays.parallelSort() in line with Arrays.sort(); it breaks an array into sub-arrays; sorting
 * those sub-arrays; merge arrays. Time Complexity is O(nlogn)
 *
 * <p>it speeds up above 100% in this example as sorting 1 million integer numbers. Parallel uses 43
 * ms Normal uses 94 ms
 *
 * <p>parallel is good at handling a big data set(> 8000 items); as handling a small data set,
 * actually it is slower than the normal sort method.
 */
public class ParallelSorting {
  ...
  private static class TimeSummer {
    private long total;
