...
/**
 * List<T> list = Array.asList(T... t) ;
 * List<T> list = Array.asList(T[] ts) ;
 * <p>
 * when using asList(), the array and the list become joined at the hip.
 * When you updating one of them, another one is updated too.
 */
public class ArrayToList {

    public static void main(String[] args) {
        LocalDate[] a = {LocalDate.of(2012, 12, 1), LocalDate.of(2013, 10, 1), LocalDate.of(2014, 4, 12)};
