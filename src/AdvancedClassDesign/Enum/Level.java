 ...
 *
 * <p>Java enum has an internal static init block to instantiate each Constant; once a Enum type is
 * loaded in the memory this static block will be executed implicitly first.
 */
public class Level {
