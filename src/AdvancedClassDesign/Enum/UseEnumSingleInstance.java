 ...
 *
 * <p>an enum is a set of constants, each of them has only one instance, which is created in its
 * super class Enum.
 *
 * <p>enum name() method is final; but toString() method can be overridden.
 *
 * <p>enum constructor cannot be public and protected, but only default and private access level.
 */
