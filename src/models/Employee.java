 ...
 *
 * <p>Abstraction class may define a constructor; otherwise compiler will add a non-argument
 * constructor.
 *
 * <p>Why need an abstraction class a constructor? The sub-class must match with the super class and
