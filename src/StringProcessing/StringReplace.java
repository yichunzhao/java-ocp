...
/**
 * replace(char old, char new) replace(CharSequence oldString, CharSequence replacement): replace
 * exact String replaceAll(String regEx, String replacement): replace regEx replaceFirst(String
 * regEx, String replacement) replace regEx
 */
public class StringReplace {
  ...
  public static void main(String[] args) {
    ...
    // replace(CharSequence oldString, CharSequence replacement)
    System.out.printf(
        "replace subString with anotherSubString %s \n ",
        str.replace(str.subSequence(2, 5), str.subSequence(3, 7)));

    // Patten.compile(charSequence var0, 16): 16 means literal, the regEx doesn't function here.
    ...
    // replaceAll(String regEx,String replacement);it doesn't accept CharSequence, i.e.
    // StringBuilder.
