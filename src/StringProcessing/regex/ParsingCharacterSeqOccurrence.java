 ...
 *
 * <p>character class: a set of characters. [] match one of characters inside the square braces.
 */
public class ParsingCharacterSeqOccurrence {
  ...
  public static void main(String[] args) {
    ...
    Arrays.asList("_", "a_", "_a", "abc_", "_abc", "abc")
        .forEach(
            s -> {
    ...
    Arrays.asList("Sh er y", "Shy", "sh er y", "Sh er a")
        .forEach(
            s -> {
              System.out.println("Does " + s + " match pattern2? " + pattern2.matcher(s).find());
            });

    // Searching usernames in a text file - find the ones that are exactly 10 characters long,
