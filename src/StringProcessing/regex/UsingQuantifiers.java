 ...
 * Quantifiers:
 *
 * <p>standing for how many times a pattern(a single character or a group) repeating itself.
 *
 * <p>X? optional 0-1 X+ 1 or many X* 0 or many
 */
    ...
    while (matcher2.find()) {
      System.out.println(
          "matcher2 group: "
              ...
              + matcher2.end()
              + " "
              + target.substring(matcher2.start(), matcher2.end()));
    }
  }
}
