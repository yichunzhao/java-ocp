 ...
 * subString(startIndex) from startIndex until the end of this String subString return String
 * subSequence return CharSequence
 *
 * <p>Throw runtime exception when index beyond the scope.
 */
public class StringSubString {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(eJava.replace(eJava.subSequence(3, 4), eJava.substring(11)));
