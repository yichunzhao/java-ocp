...
/**
 * Scanner class: parsing and tokenizing streams(IO: File, Readable,String) by using a pattern,
 * which can be character, a string literal, or a regex.
 */
public class ScannerParseAndTokenize {
  ...
  public static void main(String[] args) {
    ...
    Scanner scanner4 =
        new Scanner("1 2 4 The new 55 Programmer 44 exam").useDelimiter("[A-Za-z\\s]+");
    int total = 0;
