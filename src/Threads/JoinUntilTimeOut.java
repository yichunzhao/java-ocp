...
/**
 * Thread.join(long millis) methods with Timeout
 * when Invoker thread wait more than timeout time, then it will return from wait() at once, and continue its
 * own task until its end.
 */
