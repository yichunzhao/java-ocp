...
final class BirthDate {
  ...
  private final Date birth; // birth is a object reference var. it should be constant.
  ...
  public void modifyAge() {
    birth.setTime(
        1111190000); // final variable cannot be re-assigned, but its existing object can be
    // modified.
  }
}
