 ...
 * <p>
 * 1.final class that cannot be extended, so that it cannot be overridden to modify the states.
 * 2.private variables so that states cannot be manipulated externally.
 * 3.final variables preventing from being re-assigned.
 * 4. return a clone of value, so that modification via reference impossible.
 */
