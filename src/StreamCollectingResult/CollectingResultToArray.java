...
public class CollectingResultToArray {
    ...
    public static void main(String[] args) {
        Stream<String> words = Pattern.compile("\\s").splitAsStream("Building a Restful Web Service with Spring");
        String[] result = words.toArray(String[]::new); //String[] result = words.toArray(n->new String[n]);
