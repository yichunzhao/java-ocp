 ...
 * A Generic interface
 *
 * <p>a non-generic class implements a generic interface, by replacing its generic type parameter by
 * an actual type.
 *
 * <p>when a generic interface defines its return type as parameterised, normally it uses a
 * non-generic class to implement this generic interface.
 */
