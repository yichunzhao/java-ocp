...
/**
 * List<?> anyStuffs, wild card generic type means you can put any type in the collection. Any type
 * can be assigned to this List, but the List cannot be modified. anyStuffs.add(new Integer(4));
...
public class GenericWildCard {
  ...
  public static void main(String[] args) {
    ...
    // once the List is assigned elements, it cannot be modified later on. Somehow, like having
    // applied a final
    // keyword.
