...
/**
 * Converting a char array char[] to List<Character>. It cannot directly use Arrays.asList(T...
 * args), for the Type parameter T will be inferred as char[].
 *
 * <p>The easiest way to use Java 8 String to IntStream, and then mapToObject Character. You need
 * cast a int to Character.
 *
 * @author YNZ
 */
