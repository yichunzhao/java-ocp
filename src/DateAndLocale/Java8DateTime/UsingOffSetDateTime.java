...
/**
 * This class may be used when modeling date-time concepts in more detail, or when communicating to a database or
 * in a network protocol. it is used with handling database and communication protocol.
 * <p>
 * <p>
 * offset date time output format:
 * <p>
 * 2021-03-14T22:31:29.330+01:00
 * <p>
 * Precision to Nano sec. 1.0 E-9; Ms sec. 1.0 1.0 E-3
 * <p>
 * offset data time is an instant value differing from the UTC time instant; adding two values then get the local time
 * based on the zoned rule.
 * <p>
 * so the offsetDateTime output is your localTime at the Nano-Sec precision and with your zoned information.
 */
...
public class UsingOffSetDateTime {
    ...
    public static void main(String[] args) {
        ...
        OffsetDateTime formedOffsetDateTime = OffsetDateTime.ofInstant(Instant.now(), ZoneId.systemDefault());
        ...
        System.out.printf("current localDateTime: %s is translated into \n   offSetDateTime: %s ",
