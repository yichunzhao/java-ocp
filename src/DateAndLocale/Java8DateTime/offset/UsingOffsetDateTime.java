 ...
 * <p>
 * current local date and time, and including 9-digit nano second, then followed by a time zone
 * <p>
 * Java 8 has introduced the java.time packages, and the JDBC 4.2 API added support for the additional SQL types
 ...
 * JPA 2.2 now supports this feature out of the box by supporting the offset to UTC and by leveraging JDBC 4.2
 * support for the timezone.
 * <p>
 * JPA @Column attribute columnDefinition
