...
/**
 * same hashcode but different instance; it doesn't overlap each other; same hashcode and equalTo
 * each other; it overlaps each other; In the stream(), it requires a merger function to handle such
 * a case.
 */
class Tester {
  private int id;
