 ...
 *
 * <p>shallow copy means only the references are copied, but not creation of new instance.
 *
 * <p>in this example the time instances are shared between the origin and its clone.
 */
