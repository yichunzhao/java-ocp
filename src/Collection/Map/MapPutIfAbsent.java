 ...
 *
 * <p>The java doc says that if the specified key is not already associated with a value(or is
 * mapped to null) associates it with the given value and returns null, else returns the current
 * value;
 *
 * <p>Confused.
 *
 * <p>The putIfAbsent works with two conditions 1) if key-value is not existed;2) if key->null
 */
