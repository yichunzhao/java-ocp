...
/**
 * some of classes in java.util support the concept of "backed collections" This demo shows this
 * concept. The subMap and Map are correlated. When we add key-value to either the original or the
 * partial-copy subMap, the new entry show automatically to both.
 */
