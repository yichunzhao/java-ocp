 ...
 *
 * <p>floor finds the least key, which <=key
 *
 * <p>higherKey finds the least key that > key lowerKey finds the greatest key < key
 */
public class CeilingAndFloorApi {
  ...
  public static void main(String[] args) {
    NavigableMap<String, Integer> strLengthMap =
