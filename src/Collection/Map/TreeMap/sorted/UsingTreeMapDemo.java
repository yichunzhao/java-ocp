...
/**
 * tree map is un-ordered, but sorted. It is sorted by key instance that implements Comparable
 * interface; or by supplied Comparator.
 */
public class UsingTreeMapDemo {
  public static void main(String[] args) {
    // collecting a Stream into a tree map
    Map<String, Integer> myTreeMap =
        Arrays.asList("we", "are", "humans", "living", "on", "earth").stream()
            .collect(toMap(s -> s, s -> s.length(), (o1, o2) -> o1, TreeMap::new));
    ...
    Map<String, LocalDate> personTime3 =
        new TreeMap<>(Comparator.comparing(String::length).reversed());
