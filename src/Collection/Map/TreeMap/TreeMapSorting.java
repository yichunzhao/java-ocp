...
/**
 * by default, a treeMap is sorted according to according to elements' natural ordering, meaning
 * that implemented Comparable interface. String, Date, and Wrapper have implemented Comparable
 * interfaces.
 */
public class TreeMapSorting {
  ...
  public static void main(String[] args) throws ParseException {
    ...
    myTreeMap
        .entrySet()
        .forEach(entry -> System.out.println("date: " + entry.getKey() + " " + entry.getValue()));
