 ...
 * <p>
 * boolean containsKey(key): using hashcode() and equalTo()
 * boolean containsValue(value): using equalTo()
 * <p>
 * You need to watch out here, if both methods have been overridden correctly.
 */
class Emp {
    private String name;
