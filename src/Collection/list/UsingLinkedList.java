...
/**
 * LinkedList is a double linked list, which implement Deque that extends Queue; we also use
 * LinkedList to implement Stack and Queue.
 *
 * <p>Add: O(1) Remove: O(1) Get: O(n) Contains: O(n)
 */
