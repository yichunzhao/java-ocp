 ...
 *
 * <p>Sorting by their natural order Sorting by an external Comparator Reverse()
 */
class Person {
  private String name;
  private int age;
...
public class SortedList {
  ...
  public static void main(String[] args) {
    ...
    List<Person> people =
        Arrays.asList(new Person("Mia", 32), new Person("Paul", 20), new Person("Harry", 16));
    ...
    System.out.println(
        "sorted : "
            + people.stream().sorted(Comparator.comparingInt(Person::getAge)).collect(toList()));
  }
}
