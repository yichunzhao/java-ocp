...
public class ReverseList {
  public static final List<String> listOne =
      new ArrayList<>(Arrays.asList("Jack", "Tom", "Sam", "John", "James", "Jack"));
  public static final List<String> listTwo =
      new ArrayList<>(Arrays.asList("Jack", "Daniel", "Sam", "Alan", "James", "George"));
