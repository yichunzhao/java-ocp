...
/**
 * TreeSet sorting according to the default Natural ordering fx Numbers and String which implements Comparable interface
 * otherwise according to a customer comparator.
 *
 * @author YNZ
 */
...
public class UsingTreeSetSort {
    ...
    public static void main(String[] args) {
        ...
        List<Person> persons = Stream.of(Person.of("mike"), Person.of("mason"), Person.of("avery"), Person.of("ella"), Person.of("harper"), Person.of("ella"))
