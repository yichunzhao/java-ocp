...
/**
 * TreeSet<E> IS-A sorted set, subSet(E fromElement, E toElement); fromElement is inclusive; and
 * toElement(exclusive) tailSet(E fromElement) >= fromElement headSet(E toElement) < toElement
 */
public class SortedSetSubSet {
  ...
  public static void main(String[] args) {
    ...
    SortedSet<String> sortedStrings =
        Arrays.stream("we have a meeting today".split("\\s"))
