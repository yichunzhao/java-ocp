 ...
 *
 * <p>Add, Contains, remove takes O(log(n))
 *
 * <p>first(), last() headSet(), tailSet()
 *
 * <p>before java 7, it was possible to add null elements to an empty tree set, however it was
 * considered as a bug.
 */
