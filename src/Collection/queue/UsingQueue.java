 ...
 * <h1>Queue </h1>
 *
 * <p>LinkedList implements Dequeue interface, which extends from Queue interface. So LinkedList is
 * a Queue implementation
 *
 * <p>add()-used to add elements to the end; peek()-returns a copy of the first element;
 * remove()-removes the element: error if empty, throws NoSuchElementException. poll()-removes from
 * the top;
 */
public class UsingQueue {
  public static void main(String[] args) {
    ...
    Queue<Integer> queue =
        IntStream.range(0, 10).boxed().collect(Collectors.toCollection(LinkedList::new));
