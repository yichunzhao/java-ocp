 ...
 * <p>
 * Sorting elements according to left element < right element. incremental from left to right direction.
 * Sorting according to an external comparator in a reversed direction; or soring according to any fancy attribute.
 */
