 ...
 *
 * <p>finding out the path difference between two path; path1 relativize path2, it is read as given
 * path1, how you can find the path to path2.
 *
 * <p>It is used construct a relative path between two relative paths or two absolute paths.
 */
