 ...
 *
 * <p>File file = new File("xxx.yy) file.createNewFile or new FileWriter(file) new
 * outputStream(file)
 *
 * <p>creating a writer or stream instance, they creating the File automatically, if it is not
 * existed.
 *
 * <p>in the old File IO, a directory is a file too. You may create a File representing a dir, and
 * another File representing a file and its path.
 *
 * <p>This is so bad
 */
